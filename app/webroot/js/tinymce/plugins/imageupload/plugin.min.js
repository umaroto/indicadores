    ...
    tinymce.create("tinymce.plugins.ImageUploadPlugin", {
        init: function (e, t) {
            ...
            e.addCommand("mceImageUpload", function () {
                ...
                $(".imageUploadSubmit").bind("click", function () {
