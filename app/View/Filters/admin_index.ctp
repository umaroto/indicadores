			...
			<div id="content-table-inner">
				...
				<div id="actions-box-top" class="actions-box">
					...
					<div id="actions-box-slider-top">
						<?php
						echo $this->Html->link('Novo', array('controller' => 'filters', 'action' => 'edit', 'admin' => true), array('class' => 'action-new'));
						echo $this->Html->link('Apagar', array('controller' => 'filters', 'action' => '', 'admin' => true), array('class' => 'action-delete'));
						?>
					</div>
					<div class="clear"></div>
				</div>
					...
					<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
						...
						<tr>
							...
							<td class="options-width">
								<?php
								echo $this->Html->link('', array('controller' => 'filters', 'action' => 'edit', $filter['Filter']['id']), array('class' => 'icon-1 info-tooltip'));
								echo $this->Form->postLink(
					                '',
					                array('controller'=> 'filters', 'action' => 'delete', $filter['Filter']['id']),
					                array('confirm' => 'Tem certeza que você quer excluir esse filtro?', 'class' => 'icon-2 info-tooltip')
					            );
								?>
							</td>
						</tr>
