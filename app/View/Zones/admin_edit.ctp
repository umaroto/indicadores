<div id="page-heading"><h1><?php echo isset($this->request->data['Zone']['id']) ? 'Atualizar ' : 'Adicionar ';?>Cobertura</h1></div>
					...
					<tr valign="top">
						<td>
							<div id="step-holder">
								...
								<div class="step-dark-left">Dados da Cobertura</div>
							...
							<?php echo $this->Form->create('Post', array('onsubmit' => 'return send()')); ?>
								...
								<?php echo $this->Form->input('Zone.id');?>

								<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
									<tr>
										<th valign="top">Título:</th>
										<td>
											<?php echo $this->Form->input('Zone.title', array('class' => 'inp-form required', 'label' => false, 'div' => false));?>
										</td>
									</tr>
									<tr>
										<th>&nbsp;</th>
